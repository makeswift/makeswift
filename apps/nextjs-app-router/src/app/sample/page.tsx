 ...
 * This page should have similar/identical functionality to its Remix counterpart
 */
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-4">Makeswift + Next.js Sample</h1>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-100 p-4 rounded">
            ...
            <nav className="flex space-x-4">
              ...
              <Link href="/nonexistent" className="text-blue-500 hover:underline">404 Test</Link>
            </nav>
          </div>
        </section>
