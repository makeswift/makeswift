...
import { extractMetadataFromHtml, removeExistingMetaTags } from './lib/metadata-extractor'

import './makeswift/components'

strict(process.env.HOST, 'Set the `HOST` environment variable to the site you want to proxy.')
strict(
...
app.get('*', async (req, res) => {
  ...
  try {
    ...
    const $ = cheerio.load(await hostResponse.text())
