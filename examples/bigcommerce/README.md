...
- `BIGCOMMERCE_STORE_API_URL`
  ...
  - Since the example ID is "5yjdhtv55p" the example storefront API URL is (`https://api.bigcommerce.com/stores/5yjdhtv55p`)
=======
  - The "Access Token" created is the value that is used as `BIGCOMMERCE_ACCESS_TOKEN`
>>>>>>> parent of b264216 (revert: previous two commits for BC example)
...
<<<<<<< HEAD
  ...
  - Since the example dashboard is found at `https://store-5yjdhtv55p.mybigcommerce.com/` the example storefront API URL is `https://store-5yjdhtv55p.mybigcommerce.com/graphql`
=======
...
<<<<<<< HEAD
BIGCOMMERCE_STORE_API_TOKEN=ipupahkny78rhnuodygnrpvtl8tv0qz
BIGCOMMERCE_STORE_API_URL=https://api.bigcommerce.com/stores/5yjdhtv55p
BIGCOMMERCE_STOREFRONT_API_URL=https://store-5yjdhtv55p.mybigcommerce.com/graphql
BIGCOMMERCE_STOREFRONT_API_TOKEN="eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiJ9.eyJjaWQiOjEsImNvcnMiOltdLCJlYXQiOjE5ODI2OTIyMDIsImlhdCI6MTcwNTQzMTAwNSwiaXNzIjoiQkMiLCJzaWQiOjEwMDMwMzgxMzQsInN1YiI6ImVqYnR2d3c3ZzhlejB4MXVuMXhzN2tpaGNnaTRjaTUiLCJzdWJfdHlwZSI6MiwidG9rZW5fdHlwZSI6MX0.uGUbU9ccUlKin4zKYEMkBfqXhRwXbrY6qB8wxCj95Ct0YjUfhcQYO-ppnjc_PW4i00nX4hfu0onQqO2vXTfHTQ"
=======
