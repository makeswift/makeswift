...
If this installation of Catalyst was created using the [Catalyst CLI](https://www.catalyst.dev/docs/cli), you should already be connected to a store and can get started immediately by running:
