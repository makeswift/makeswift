...
1. **MAKESWIFT_SITE_API_KEY**: Found in your Makeswift site settings.
2. **NEXT_PUBLIC_ALGOLIA_APP_ID**: Your Algolia Application ID, found in your Algolia dashboard settings under API Keys.
3. **NEXT_PUBLIC_ALGOLIA_SEARCH_API_KEY**: Also found in the Algolia dashboard settings under API Keys.
4. **NEXT_PUBLIC_ALGOLIA_INDEX_NAME**: The name of the Algolia index you want to use for search (create or select one in your Algolia dashboard).
5. **ALGOLIA_SITE_VERIFICATION**: The verification code from the Algolia Crawler meta tag (see next step for instructions).
...
2. In your Makeswift settings, set your deployed domain as the custom host
