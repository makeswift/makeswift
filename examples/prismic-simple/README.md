...
**Create a new custom type called "BlogPost" with the following fields:**

- **Title** (Text) - The post title (mark as "Title field for this Custom Type")
- **Feed Date** (Date) - Publication date
- **Body** (Rich Text) - Main content
- **Hero** (Image) - Hero image for the post
