...
### (internal) `appOrigin` and `appOrigin` params

Undocumented `appOrigin` and `appOrigin` params are now passed directly to the `ReactRuntime` constructor. See [internal apps](/apps/) for details.
