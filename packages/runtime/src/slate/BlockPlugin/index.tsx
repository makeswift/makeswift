...
function BlockPluginComponent({
  ...
  const { className: blockStylesClassName, styleElement: blockStylesStyleElement } = useStyle({
    margin: 0,
  })
  const quoteStyles = {
    padding: '0.5em 10px',
  ...
  const { className: quoteStylesClassName, styleElement: quoteStylesStyleElement } =
    useStyle(quoteStyles)
  ...
  const { className: unorderedListStylesClassName, styleElement: unorderedListStyleElement } =
    useStyle(unorderedListStyles)
  ...
  const { className: orderedListStylesClassName, styleElement: orderedListStyleElement } =
    useStyle(orderedListStyles)
  ...
  switch (props.element.type) {
    ...
    case BlockType.BlockQuote:
      return (
        <>
          ...
          <blockquote
            {...props.attributes}
            className={clsx(blockStylesClassName, quoteStylesClassName, props.element.className)}
          >
            {renderElement(props)}
          </blockquote>
        </>
    ...
    case BlockType.OrderedList:
      return (
        <>
          {blockStylesStyleElement}
          {orderedListStyleElement}
          <ol
            {...props.attributes}
            className={clsx(
              blockStylesClassName,
              orderedListStylesClassName,
    ...
    case BlockType.UnorderedList:
      return (
        <>
          {blockStylesStyleElement}
          {unorderedListStyleElement}
          <ul
            {...props.attributes}
            className={clsx(
              blockStylesClassName,
              unorderedListStylesClassName,
              props.element.className,
            )}
          >
            {renderElement(props)}
    ...
    case BlockType.ListItemChild:
      return (
        <>
          ...
          <span
            {...props.attributes}
            className={clsx(blockStylesClassName, props.element.className)}
          >
            {renderElement(props)}
          </span>
        </>
