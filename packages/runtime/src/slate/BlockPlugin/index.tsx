...
function BlockPluginComponent({
  ...
  const { className: blockStylesClassName, styleElement: blockStylesStyleElement } = useStyle({ margin: 0 })
  const quoteStyles = {
    padding: '0.5em 10px',
    fontSize: '1.25em',
    fontWeight: '300',
  ...
  const { className: unorderedListStylesClassName, styleElement: unorderedListStyleElement } = useStyle(unorderedListStyles)
  ...
  const { className: orderedListStylesClassName, styleElement: orderedListStyleElement } = useStyle(orderedListStyles)
