...
function usePaddingStyle(
  ...
  return useLegacyControlledStyle(useResponsivePadding(value), elementKey, propName)
}
...
function useMarginStyle(
  ...
  return useLegacyControlledStyle(useResponsiveMargin(value), elementKey, propName)
}
...
function useBorderRadiusStyle(
  ...
  return useLegacyControlledStyle(useResponsiveBorderRadius(value), elementKey, propName)
}
        ...
        case PaddingPropControllerFormat.ClassName:
          return (
            <RenderHook
              ...
              parameters={[elementKey, propName, propData]}
            >
              {({ className, styleElement }) => (
                <>
                  {styleElement}
