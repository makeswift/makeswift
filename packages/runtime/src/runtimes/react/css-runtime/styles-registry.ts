...
export class StylesRegistry {
  ...
  */
  ...
  getUncontrolledClassStyles(): ReadonlyMap<string, ClassStyleData> {
    return this.uncontrolledClassStyles
  }

  getControlledStyles(namespace: string): ReadonlyMap<string, ControlledStyleData> {
    return this.getOrCreateControlledStylesMapForNamespace(namespace)
  }

  getKeyframes(): ReadonlyMap<string, KeyframesData> {
    return this.keyframes
  }

  getCssResets(): ReadonlyMap<string, CssResetData> {
    return this.cssResets
  }

  getBaseStyles(): ReadonlyMap<string, BaseStylesData> {
  ...
  */
  ...
  setControlledStyle({
    ...
    if (previousData != null && previousData.contentHash === data.contentHash) {
      return
    }
