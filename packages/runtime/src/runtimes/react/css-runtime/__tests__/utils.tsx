...
import { DataType, ElementData, StyleDefinition as StyleV1Definition } from '@makeswift/controls'
...
export function createStyleV1TestFixtures({
  siteVersion,
  controlDefinition,
  sampleData,
}: {
 ...
 */
export function clearDocumentCachedHoistedResources() {
