...
describe('copyElementTree', () => {
  ...
  test('returns a copy of the tree with replaced IDs', () => {
    const result = runtime.copyElementTree(elementTree, {
      ...
      tableColumnIds: {
        'U2luZ2xlTGluZVRleHRUYWJsZUNvbHVtbjo2MDZhY2E0NC1iYmVjLTQ4NzMtYTdiOC1kYTEwZWNjZTQ4OTQ=': '[replaced-table-column-id-1]',
        'TG9uZ1RleHRUYWJsZUNvbHVtbjpjYjMwOWMyMi04Njc3LTQ1OTctYTI2ZC1mZWY3NGU4MGY5YTM=': '[replaced-table-column-id-2]',
        'TnVtYmVyVGFibGVDb2x1bW46OGJiZDAzZmMtYmZlMi00OTEzLTlkMGItNWZhNDAzMzhlZTBh': '[replaced-table-column-id-3]',
      },
    })
