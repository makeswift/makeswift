...
export function BlockElement({ element, attributes, children }: InlineRenderElementProps) {
  const simpleBlockStyles = [useStyle({ margin: 0 })]
  switch (element.type) {
    case BlockType.Text:
      return (
        <span {...attributes} className={cx(...simpleBlockStyles)}>
          {children}
        </span>
      )
    case BlockType.OrderedList:
      return (
        <ol
          {...attributes}
          className={cx(...simpleBlockStyles)}
    ...
    case BlockType.ListItem:
      return (
        <li {...attributes} className={cx(...simpleBlockStyles)}>
          {children}
        </li>
      )
