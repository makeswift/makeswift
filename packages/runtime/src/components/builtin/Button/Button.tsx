...
const Button = forwardRef(function Button<T extends ElementType = 'button'>(
      ...
      return {
        ...
        ...{
          ...
          outline: {
            ...
            ':hover': {
              boxShadow: `inset 0 0 0 2px ${ColorHelper(colorToString(color)).darken(0.1).hex()}`,
              color: ColorHelper(colorToString(color)).darken(0.1).hex(),
            },

            ':active': {
              boxShadow: `inset 0 0 0 2px ${ColorHelper(colorToString(color)).darken(0.15).hex()}`,
  ...
  return (
    <>
      ...
      <Component {...restOfProps} ref={ref} id={id} className={buttonStyles.className} link={link}>
