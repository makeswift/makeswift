...
import { useTableRecordClient } from '../../../runtimes/react/hooks/use-table-record-client'
...
const GridForm = forwardRef(function GridFrom(
  ...
  return (
    <>
      ...
      <form {...restOfProps} ref={ref} className={styles.className} />
    </>
  )
})
...
const GridItem = forwardRef(function GridItem(
  ...
  return (
    <>
      {styles.styleElements}
      <div {...restOfProps} ref={ref} className={styles.className} />
    </>
  )
})
...
function StyledButton({ className, size, alignment, ...restOfProps }: StyledButtonProps) {
  ...
  return (
    <>
      {styles.styleElements}
      <Button {...restOfProps} as="button" className={styles.className} />
    </>
  )
}
...
function IconContainer({ className, ...restOfProps }: ComponentPropsWithoutRef<'div'>) {
  const styles = composeStyles(useStyle({ fill: 'currentColor' }), className)
  return (
    <>
      {styles.styleElements}
      <div {...restOfProps} className={styles.className} />
...
function ErrorMessage({ className, ...restOfProps }: ComponentPropsWithoutRef<'p'>) {
  ...
  return (
    <>
      {styles.styleElements}
      <p {...restOfProps} className={styles.className} />
    </>
  )
}
...
const Form = forwardRef(function Form(
  ...
  const client = useTableRecordClient()
