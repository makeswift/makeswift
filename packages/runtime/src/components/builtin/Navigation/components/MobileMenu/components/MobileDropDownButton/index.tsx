...
function DropDownMenu({ className, open, ...restOfProps }: DropDownMenuProps) {
  ...
  return (
    <>
      {baseStyleElement}
      <div {...restOfProps} className={clsx(baseClassName, className)} />
    </>
  )
}
...
function DropDownItem({ color, className, textStyle, ...restOfProps }: DropDownItemProps) {
  ...
  const { className: responsiveTextStyleClassName, styleElement: responsiveTextStylesElement } =
    useStyle(useResponsiveTextStyle(textStyle))
  const { className: responsiveColorClassName, styleElement: responsiveColorStylesElement } =
    useStyle(
