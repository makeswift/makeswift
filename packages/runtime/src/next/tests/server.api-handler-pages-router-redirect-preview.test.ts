    ...
    ({ fixture }) => {
      ...
      test('sets preview mode cookies, redirects to the original URL', async () => {
        ...
        expect(headers.getSetCookie()).toEqual([
          ...
          '__next_preview_data=%7B%22siteVersion%22%3A%22eyJ2ZXJzaW9uIjoicmVmOndvcmtpbmciLCJ0b2tlbiI6InRlc3QtcHJldmlldy10b2tlbiJ9%22%7D; Path=/; HttpOnly; Secure; Partitioned; SameSite=None',
        ])
