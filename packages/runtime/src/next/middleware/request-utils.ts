...
export function isMakeswiftDraftRequest(request: NextRequest): boolean {
  return isDraftModeRequest(request) || isPreviewModeRequest(request)
}

export function getMakeswiftDraftSecret(request: NextRequest): string | null {
...
export async function createMakeswiftDraftRequest(
