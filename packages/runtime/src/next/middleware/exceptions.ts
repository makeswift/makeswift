export const MiddlewareErrorCodes = {
  ...
  INVALID_DRAFT_RESPONSE_BODY: 'INVALID_DRAFT_RESPONSE_BODY',
...
export const MiddlewareErrorNames = {
  ...
  [MiddlewareErrorCodes.INVALID_DRAFT_RESPONSE_BODY]: 'InvalidDraftResponseBodyError',
...
export class InvalidDraftResponseBodyError extends MiddlewareError {
  constructor(message: string) {
    super(MiddlewareErrorCodes.INVALID_DRAFT_RESPONSE_BODY, message)
  }
}
