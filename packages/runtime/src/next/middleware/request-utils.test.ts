    ...
    test.each([
      ...
      [
        ...
        new NextRequest(new URL(TEST_PATH), {
          headers: {
            cookie: `__prerender_bypass=123456; makeswift-version-data={"version":"ref:working", "token":"${TEST_PREVIEW_TOKEN}"}`,
          },
        }),
        true,
      ],
      ...
      [
        ...
        new NextRequest(new URL(TEST_PATH), {
          headers: {
            cookie: `makeswift-version-data={"version":"ref:working", "token":"${TEST_PREVIEW_TOKEN}"}`,
          },
        }),
        false,
      ],
