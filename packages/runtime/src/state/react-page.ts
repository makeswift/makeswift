...
// import { readlOnlyElementTreeMiddleware } from './middleware/read-only-element-tree'
...
//       getDefaultMiddleware(middlewareOptions).concat(readlOnlyElementTreeMiddleware()),
